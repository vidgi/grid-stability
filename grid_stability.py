...
st.write("As renewable energy sources are increasingly adopted, an infrastructure of new paradigms is necessary to account for more production sources and the management of a much more flexible and complex system that can connect producers, consumers, and distribution.")
